...
<template>
    ...
    <BasicLayout :messages="messages">
        ...
        <div class="flex flex-col gap-4 md:gap-2 mt-8 w-4/5 md:w-3/5 mx-auto pb-16">
            <strong>Privacy Policy</strong>
            <p>This privacy policy applies to the Reversi Lab app (hereby referred to as "Application") for mobile
                devices that
                was created by Kenji Shimizu (hereby referred to as "Service Provider") as a Free service. This service
                is
            ...
            <p>For a better experience, while using the Application, the Service Provider may require you to provide us
                with
                certain personally identifiable information. The information that the Service Provider request will be
                retained
            ...
            <p>The Service Provider will retain User Provided data for as long as you use the Application and for a
                ...
                Application,
                please contact them at hello@pitapaka.com and they will respond in a reasonable time.</p>
            ...
            <div><br>
                <p>The Application does not address anyone under the age of 13.
                    ...
                    personal information, please contact the Service Provider (hello@pitapaka.com) so that
            ...
            <p>This privacy policy is effective as of 2024-12-01</p><br><strong>Your Consent</strong>
            ...
            <p>If you have any questions regarding privacy while using the Application, or have questions about the
                practices,
                please contact the Service Provider via email at hello@pitapaka.com.</p>
            <hr>
